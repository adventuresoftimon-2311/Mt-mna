    ...
    <section class="fade-in" style="padding: 15vh 0; background-color: var(--secondary-bg);">
      <div class="container" style="max-width: 1400px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
          ...
          <!-- Step 1 -->
          <div class="card product-tile" style="position: relative; overflow: hidden; padding: 0; aspect-ratio: 4/5; border: none; box-shadow: 0 20px 40px rgba(15, 23, 42, 0.15); border-radius: 0;">
