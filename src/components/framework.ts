    ...
    <section class="fade-in" style="animation-delay: 0.2s; padding: 0;">
      ...
      <div class="horizontal-container" id="framework-scroll-container" style="position: relative; overflow: hidden;">
        ...
        <div class="horizontal-wrapper" id="framework-scroll-wrapper" style="position: relative; z-index: 1;">
          ...
          <!-- Pillar 1 -->
          <div class="horizontal-panel" style="width: 950px; flex-shrink: 0; padding-left: 400px;">
            <!-- Huge Background Text (Left Side) -->
            <div style="position: absolute; left: 50px; top: 50%; transform: translateY(-50%); text-align: left; pointer-events: none; z-index: 0; width: 350px;">
              ...
              <p style="margin-right: auto; margin-top: 1rem; color: var(--text-secondary); font-size: 1rem; text-align: left; opacity: 0.8;">Building foundational architecture for durable market leadership.</p>
            </div>
          ...
          <div class="horizontal-panel" style="width: 950px; flex-shrink: 0; padding-left: 400px;">
            ...
            <div style="position: absolute; left: 50px; top: 50%; transform: translateY(-50%); text-align: left; pointer-events: none; z-index: 0; width: 350px;">
              ...
              <p style="margin-right: auto; margin-top: 1rem; color: var(--text-secondary); font-size: 1rem; text-align: left; opacity: 0.8;">Strategic elevation of high-potential assets through integration.</p>
            </div>
          ...
          <div class="horizontal-panel" style="width: 950px; flex-shrink: 0; padding-left: 400px;">
            ...
            <div style="position: absolute; left: 50px; top: 50%; transform: translateY(-50%); text-align: left; pointer-events: none; z-index: 0; width: 350px;">
              ...
              <p style="margin-right: auto; margin-top: 1rem; color: var(--text-secondary); font-size: 1rem; text-align: left; opacity: 0.8;">Embedding deliberate governance and scalable systems for endurance.</p>
            </div>
